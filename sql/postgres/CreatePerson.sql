-- Postgres port of mysql/CreatePerson.sql (legacy; no on_chest).
-- NOTE: This function does NOT exist on live Neon (only CreatePerson_v002 does).
-- See DIFFS.md.

CREATE OR REPLACE FUNCTION lorebot."CreatePerson"(
...
BEGIN
  INSERT INTO lorebot.person (
    ...
    both_hands, submitter, create_date, clan_id
  )
  VALUES (
    ...
    p_both_hands, p_submitter, NOW(), p_clan_id
  )
